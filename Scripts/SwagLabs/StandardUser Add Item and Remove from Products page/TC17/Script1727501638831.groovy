...
WebUI.verifyElementPresent(findTestObject('SwagLab/Page_Swag Labs/button_ADD TO CART - Sauce Labs Onesie'), 0)
...
WebUI.verifyElementPresent(findTestObject('SwagLab/Page_Swag Labs/button_REMOVE - Sauce Labs Onesie'), 0)

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/button_REMOVE - Sauce Labs Onesie'), 'REMOVE')

WebUI.click(findTestObject('SwagLab/Page_Swag Labs/button_REMOVE - Sauce Labs Onesie'))
