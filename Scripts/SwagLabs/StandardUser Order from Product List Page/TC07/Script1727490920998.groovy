...
WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/item_29.99'), '29.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/item_29.99'), '$29.99')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Item total 29.99'), 'Item total: $29.99')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Tax 2.40'), 'Tax: $2.40')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Total 32.39'), 'Total: $32.39')
