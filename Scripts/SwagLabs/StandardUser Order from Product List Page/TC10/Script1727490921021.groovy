...
WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/item_49.99'), '49.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Item total 49.99'), 'Item total: $49.99')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Tax 4.00'), 'Tax: $4.00')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Total 53.99'), 'Total: $53.99')
