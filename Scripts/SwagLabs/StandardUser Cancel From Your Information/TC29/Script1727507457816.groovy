...
WebUI.doubleClick(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Accepted usernames are                s_40dcc1'))

WebUI.setText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/input_standard_userlocked_out_userproblem_u_db77ac'), 
    'standard_user')

WebUI.doubleClick(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Password for all users                s_477655'))
