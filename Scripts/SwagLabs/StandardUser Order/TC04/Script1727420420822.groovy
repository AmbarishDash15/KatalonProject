...
WebUI.click(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Fleece Jacket'))

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/item_Sauce Labs Fleece Jacket'), 'Sauce Labs Fleece Jacket')

WebUI.verifyElementVisible(findTestObject('Object Repository/SwagLab/Page_Swag Labs/img_- Back_inventory_details_img'))

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_49.99'), '$49.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Fleece Jacket'), 'Sauce Labs Fleece Jacket')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_49.99_1'), '49.99')
