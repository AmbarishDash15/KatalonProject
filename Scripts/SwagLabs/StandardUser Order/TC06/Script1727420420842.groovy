...
WebUI.click(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Test.allTheThings() T-Shirt (Red)'))

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/item_Test.allTheThings'), 'Test.allTheThings() T-Shirt (Red)')

WebUI.verifyElementVisible(findTestObject('Object Repository/SwagLab/Page_Swag Labs/img_- Back_inventory_details_img'))

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_15.99'), '$15.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Test.allTheThings() T-Shirt (Red)'), 
    'Test.allTheThings() T-Shirt (Red)')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_15.99_1'), '15.99')
