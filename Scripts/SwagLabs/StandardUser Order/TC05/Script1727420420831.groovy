...
WebUI.click(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Accepted usernames are                s_40dcc1'))
...
WebUI.click(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Onesie'))

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/item_Sauce Labs Onesie'), 'Sauce Labs Onesie')

WebUI.verifyElementVisible(findTestObject('Object Repository/SwagLab/Page_Swag Labs/img_- Back_inventory_details_img'))

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_7.99'), '$7.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Onesie'), 'Sauce Labs Onesie')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_7.99_1'), '7.99')
