...
WebUI.click(findTestObject('SwagLab/Page_Swag Labs/a_Sauce Labs Bolt T-Shirt'))

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/div_Sauce Labs Bolt T-Shirt'), 'Sauce Labs Bolt T-Shirt')
...
WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/a_Sauce Labs Bolt T-Shirt'), 'Sauce Labs Bolt T-Shirt')
