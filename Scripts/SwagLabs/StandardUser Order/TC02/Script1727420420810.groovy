...
WebUI.verifyElementPresent(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Open Menu_app_logo'), 0)

WebUI.click(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Bike Light'))

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_9.99'), '$9.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Sauce Labs Bike Light'), 'Sauce Labs Bike Light')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_9.99_1'), '9.99')
...
WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Item total 9.99'), 'Item total: $9.99')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Tax 0.80'), 'Tax: $0.80')

WebUI.verifyElementText(findTestObject('Object Repository/SwagLab/Page_Swag Labs/div_Total 10.79'), 'Total: $10.79')
