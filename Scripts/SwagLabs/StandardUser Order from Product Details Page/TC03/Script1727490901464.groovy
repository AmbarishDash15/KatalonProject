...
WebUI.click(findTestObject('SwagLab/Page_Swag Labs/link_Sauce Labs Bolt T-Shirt'))

WebUI.verifyElementText(findTestObject('SwagLab/Page_Swag Labs/details_Sauce Labs Bolt T-Shirt'), 'Sauce Labs Bolt T-Shirt')
