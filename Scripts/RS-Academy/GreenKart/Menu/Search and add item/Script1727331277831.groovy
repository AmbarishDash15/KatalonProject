...
WebUI.setText(findTestObject('RS-Academy/Page_GreenKart - veg and fruits kart/input_KART_search-keyword'), item)

WebUI.click(findTestObject('RS-Academy/Page_GreenKart - veg and fruits kart/button_KART_search-button'))
...
if (totalPrice.toInteger() == (unitPrice.toInteger() * quantity.toInteger())) {
    assert true
} else {
    assert false
}
